        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="flex gap-1">
              ...
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m8 13l3 3l5-7m6 3c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10"></path>
                </svg>
              ...
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m14 8l-3 3l-1-1"></path>
                </svg>
    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
        active
          ...
          : highlight
            ? "text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:hover:text-blue-900 dark:hover:bg-blue-950"
            : "text-gray-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:text-zinc-900 dark:hover:bg-zinc-800"
      }`}
    >
      {children}
    </button>
