              ...
              <table className="w-full text-center">
                <thead>
                  <tr className="border-b-2 border-gray-200 bg-gray-50">
                    ...
                    <th className="px-4 py-3 text-sm font-semibold text-gray-600">Multi Engine Sea</th>
                ...
                <tbody>
                  {paged.map((flight, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.total_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.sel_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.ses_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.mel_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.mes_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.helicopter_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.glider_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.pic_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.sic_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.dual_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.instructor_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.xcountry_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.night_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.act_instrument_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.sim_instrument_time ?? 0).toFixed(1)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{(flight.sim_time ?? 0).toFixed(1)}</td>
